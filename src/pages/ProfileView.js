...
function ProfileView({ data, newObject }) {
    ...
    const fetchPosts = async () => {
        axios
            .get(`http://localhost:5000/api/v1/user/posts/${authContext.user._id}?limit=${limit}&page=${page}`, {
                headers: {
    ...
    useEffect(async () => {
        ...
        axios
            .get(`http://localhost:5000/api/v1/user/profile/${authContext.user._id}`, {
                headers: {
    ...
    return (
        <div className="container">
            ...
            <img className="profile_img" src={`${profile? 'http://localhost:5000'+profile.picture :avatar}`} alt="profile_img" />
            {/* Profile Name */}
